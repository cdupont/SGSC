...
This will allow an energy-aware PaaS framework to make better decisions, for instance for for applications consolidation, and trade-offs. %\ms{more description needed: e.g. make better decision for apps consolidation, etc.}
