...
The paper also discusses how the combination of IaaS and PaaS consolidation techniques can improve energy saving and cleverly applied to reduce carbon emissions and energy consumption by scaling up and down applications following the curve of green energy availability. %\ms{not sure about green discussion, but that make sense if we provide some more description and intuition}
